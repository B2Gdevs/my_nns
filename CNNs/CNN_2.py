...
class my_net(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(in_channels=8, out_channels=64, stride=1, kernel_size=3, padding=1)
        ...
        self.conv3 = nn.Conv2d(in_channels=64, out_channels=64, stride=1, kernel_size=2, padding=0)
        # size of feature map
        # (7 - 2) + (2(0)/1) + 1 = 6
        self.batch_norm3 = nn.BatchNorm2d(64)
        self.pool3 = nn.MaxPool2d(kernel_size=2) # 6/2 = 3
        

        input_neurons = 64*3*3 # 32 feature maps that are now 7x7
